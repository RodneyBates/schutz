            ...
            ; IF MteState # MteStateTyp . MteStateDone  
              ...
              ; NewBolTokMark 
                := Marks . TokMarkTyp 
                     ...
                     , TkmFmtNo := FsNodeRef . FsFmtNo 
                     , TkmStartAtEnd := FALSE
                     , TkmIsImpliedNewLine := NOT ModCmnt . ModCmntNlBefore 
                     , TkmTok := LTok  
                     } 
              ; INC ( MteMarkCt ) 
              ; MteState := MteStateTyp . MteStateDone 
...
*) 
      ...
      ; Assert 
          ( NewBolTokMark . TkmEstNodeCt = EstUtil . EstNodeCt ( LNewMarkedEstRef )
